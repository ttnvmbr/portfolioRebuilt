...
export const projectData = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Rat Soup is a 2.5D merge and collect mobile game. This game was commisioned by the Game Design & Development minor program and was produced in only four weeks by a multidisciplinary team of six students functioning as a game studio, which I was proudly part of. As one of only three developers, I contributed in a large part of the development process of the game. I focused on designing and developing a way to efficiently store and retrieve all game data that made it easier to manage for both the developpers and designers.",
        descriptionNl:
    ...
    projects: [
      {
        ...
        description:
          "HeelTech are heels that generate and store energy by walking to charge your phone with. I made them as part of a project commisioned by the Creative Media & Game Technologies program. The project consisted of concepting, researching, designing and developing an innovative appliance or application.",
        descriptionNl:
